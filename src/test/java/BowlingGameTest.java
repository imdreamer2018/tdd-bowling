...
public class BowlingGameTest {
    ...
    @Test
    void should_throw_invalid_input_exception_when_score_rounds_less_than_10_times() {

        BowlingGame bowlingGame = new BowlingGame();

        List<Integer> scoreOfKnockingDownTheBall = Arrays.asList(4,4,10,4,6,4,3,4,6,4,6,2,4,6,4,6);
